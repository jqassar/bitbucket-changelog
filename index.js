#!/usr/bin/env node
// It would be very foolish of anybody to fork off of this.
// This is being used to debug Bitbucket DB errors generated by the current invocation of this plugin.
...
function getPullRequests(branch, state, since, start, size, results) {
	return getPullRequestsPage(branch, state, start, size).then(res => {
		...
		// Add an else...
		else { print('no filtering of PRs in this call to get PRs...') }
...
function *buildReleases() {
	...
	// What on earth is this doing, Bitbucket-wise?
